...
$body_color = '';
  ...
  $color_mmenu_hover = '.kad-mobile-nav .kad-nav-inner li.current-menu-item>a, .kad-mobile-nav .kad-nav-inner li a:hover, #kad-banner #mobile-nav-trigger a.nav-trigger-case:hover .kad-menu-name, #kad-banner #mobile-nav-trigger a.nav-trigger-case:hover .kad-navbtn, .nav-trigger-case:hover .kad-navbtn {color:'.$virtue_premium['mobilemenu_hover_color'].';}';
  } else {
  $color_mmenu_hover = '';
  }
...
if(!empty($virtue_premium['primary20_color'])) {
  $color_primary30 =  'a:hover {color: '.$virtue_premium['primary20_color'].';} .kad-btn-primary:hover, .login .form-row .button:hover, #payment #place_order:hover, .yith-wcan .yith-wcan-reset-navigation:hover, .widget_shopping_cart_content .checkout:hover,.single_add_to_cart_button:hover,
